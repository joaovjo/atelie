...
?>
  ...
  <main class="pb-24">
    <div class="text-center py-16 px-4 sm:px-6 lg:px-8">
      ...
      <p class="mt-4 max-w-xl mx-auto text-base text-gray-500">Faça a sua vida mais doce! </p>
    </div>

    <!-- categorias de Produtos -->
    <section aria-labelledby="filter-heading" class="relative z-10 border-t border-b border-gray-200 grid items-center">
      <h2 id="filter-heading" class="sr-only">Categorias</h2>
      <div class="relative col-start-1 row-start-1 py-4">
        <div class="max-w-7xl mx-auto flex space-x-6 divide-x divide-gray-200 text-sm px-4 sm:px-6 lg:px-8">
          ...
          <div class="pl-6">
            <button type="button" class="text-gray-500">Limpar tudo</button>
          </div>
        </div>
      </div>
      ...
      <div class="-mx-px border-l border-gray-200 grid grid-cols-2 sm:mx-0 md:grid-cols-3 lg:grid-cols-4">
        <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
          ...
          <div class="pt-10 pb-4 text-center">
            ...
            <div class="mt-3 flex flex-col items-center">
              ...
              <p class="mt-1 text-sm text-gray-500">Valor por Kg</p>
            </div>
            <p class="mt-4 text-base font-medium text-gray-900">$60</p>
          </div>
        </div>
        ...
        <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
          ...
          <div class="pt-10 pb-4 text-center">
            ...
            <p class="mt-4 text-base font-medium text-gray-900">$65</p>
          </div>
        </div>
        ...
        <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
          ...
          <div class="pt-10 pb-4 text-center">
            ...
            <p class="mt-4 text-base font-medium text-gray-900">$70</p>
          </div>
        </div>
        ...
        <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
          ...
          <div class="pt-10 pb-4 text-center">
            ...
            <p class="mt-4 text-base font-medium text-gray-900">$17</p>
          </div>
        </div>
        ...
        <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
          <div class="rounded-lg overflow-hidden bg-gray-200 aspect-w-1 aspect-h-1 group-hover:opacity-75">
            <img src=".img/bolo_laranja.png" alt="TODO" class="w-full h-full object-center object-cover">
          </div>
          <div class="pt-10 pb-4 text-center">
            <h3 class="text-sm font-medium text-gray-900">
              <a href="#">
        ...
        <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
          <div class="rounded-lg overflow-hidden bg-gray-200 aspect-w-1 aspect-h-1 group-hover:opacity-75">
            <img src=".img/bolo_piscina.png" alt="TODO" class="w-full h-full object-center object-cover">
          </div>
          <div class="pt-10 pb-4 text-center">
            <h3 class="text-sm font-medium text-gray-900">
              <a href="#">
                <span aria-hidden="true" class="absolute inset-0"></span>
                Bolo Piscina de Chocolate
              </a>
            </h3>
            <div class="mt-3 flex flex-col items-center">
              <p class="sr-only">Avaliação</p>
        ...
        <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
          <div class="rounded-lg overflow-hidden bg-gray-200 aspect-w-1 aspect-h-1 group-hover:opacity-75">
            <img src=".img/bolo_vermelho.png" alt="TODO" class="w-full h-full object-center object-cover">
          </div>
          <div class="pt-10 pb-4 text-center">
            <h3 class="text-sm font-medium text-gray-900">
              <a href="#">
            ...
            <p class="mt-4 text-base font-medium text-gray-900">$80</p>
          </div>
        </div>
        ...
        <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
          ...
          <div class="pt-10 pb-4 text-center">
            <h3 class="text-sm font-medium text-gray-900">
              <a href="#">
                <span aria-hidden="true" class="absolute inset-0"></span>
                Bolo Retangular de Brigadeiro com Morango
              </a>
            </h3>
            <div class="mt-3 flex flex-col items-center">
              <p class="sr-only">Avaliação</p>
        ...
        <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
          ...
          <div class="pt-10 pb-4 text-center">
            ...
            <div class="mt-3 flex flex-col items-center">
              ...
              <p class="mt-1 text-sm text-gray-500">100 Unidades</p>
            </div>
            <p class="mt-4 text-base font-medium text-gray-900">$190</p>
          </div>
        </div>

        <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
          <div class="rounded-lg overflow-hidden bg-gray-200 aspect-w-1 aspect-h-1 group-hover:opacity-75">
            <img src=".img/brigadeiro-bicho-de-pe.png" alt="TODO" class="w-full h-full object-center object-cover">
          </div>
          <div class="pt-10 pb-4 text-center">
            <h3 class="text-sm font-medium text-gray-900">
              <a href="#">
                <span aria-hidden="true" class="absolute inset-0"></span>
                Doces Bicho do Pé/ Brigadeiro / Trufa de café
              </a>
            </h3>
            <div class="mt-3 flex flex-col items-center">
              <p class="sr-only">Avaliação</p>
        ...
        <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
          ...
          <div class="pt-10 pb-4 text-center">
            ...
            <p class="mt-4 text-base font-medium text-gray-900">$200</p>
          </div>
        </div>
        ...
        <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
          ...
          <div class="pt-10 pb-4 text-center">
            <h3 class="text-sm font-medium text-gray-900">
              <a href="#">
                <span aria-hidden="true" class="absolute inset-0"></span>
                Doces Beijinho / Brigadeiro / Trufa de café
              </a>
            </h3>
            <div class="mt-3 flex flex-col items-center">
              <p class="sr-only">Avaliação</p>
            ...
            <p class="mt-4 text-base font-medium text-gray-900">$130</p>
          </div>
        </div>
        ...
        <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
          ...
          <div class="pt-10 pb-4 text-center">
            ...
            <p class="mt-4 text-base font-medium text-gray-900">$140</p>
          </div>
        </div>
        ...
        <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
          ...
          <div class="pt-10 pb-4 text-center">
            ...
            <p class="mt-4 text-base font-medium text-gray-900">$120</p>
          </div>
        </div>

        <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
          <div class="rounded-lg overflow-hidden bg-gray-200 aspect-w-1 aspect-h-1 group-hover:opacity-75">
            <img src=".img/mix_doces.png" alt="TODO" class="w-full h-full object-center object-cover">
          </div>
          <div class="pt-10 pb-4 text-center">
            <h3 class="text-sm font-medium text-gray-900">
              <a href="#">
            ...
            <p class="mt-4 text-base font-medium text-gray-900">$180</p>
          </div>
        </div>
