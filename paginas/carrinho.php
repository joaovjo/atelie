<?php include "../layout/cabecalho.php"; ?>
      ...
      <div
        ...
        <div class="relative">
          ...
          <div class="max-w-full">
            <img src="./public/img/carrossel.png" alt="" class="w-full h-full object-center object-fill">
          </div>
        </div>
      </div>
            ...
            <div class="relative w-full overflow-x-auto">
              <ul role="list"
                ...
                <li class="w-64 inline-flex flex-col text-center lg:w-auto">
                  <div class="group relative">
                    <div class="w-full bg-gray-200 rounded-md overflow-hidden aspect-w-1 aspect-h-1">
                      <img src="./public/img/bolo_laranja.png" alt=""
                ...
                <li class="w-64 inline-flex flex-col text-center lg:w-auto">
                  <div class="group relative">
                    <div class="w-full bg-gray-200 rounded-md overflow-hidden aspect-w-1 aspect-h-1">
                      <img src="./public/img/bolo_vermelho.png" alt=""
                        class="w-full h-full object-center object-cover group-hover:opacity-75">
                    </div>
                    <div class="mt-6">
                ...
                <li class="w-64 inline-flex flex-col text-center lg:w-auto">
                  <div class="group relative">
                    <div class="w-full bg-gray-200 rounded-md overflow-hidden aspect-w-1 aspect-h-1">
                      <img src="./public/img/mix_doces.png" alt=""
                        class="w-full h-full object-center object-cover group-hover:opacity-75">
                    </div>
                    <div class="mt-6">
                ...
                <li class="w-64 inline-flex flex-col text-center lg:w-auto">
                  <div class="group relative">
                    <div class="w-full bg-gray-200 rounded-md overflow-hidden aspect-w-1 aspect-h-1">
                      <img src="./public/img/bolo_piscina.png" alt=""
                        class="w-full h-full object-center object-cover group-hover:opacity-75">
                    </div>
                    <div class="mt-6">
    ...
    <!--  DELETAR ONDE NOS ENCONTRAR (criar link para o menu)-->
